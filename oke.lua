...
local bloxfutiSignal, fruitChance do
    -- updated for script-ware or whatever
    -- attempted to update for krnl

    function bloxfutiSignal(target, signal, ...)
    ...
    function rollChance()
        ...
        if Options.FeatureMode.Value == 'Manual' then
            if (Options.bloxfutiBind:GetState()) then return 'Sick' end

            return 'Bad' -- incase if it cant find one
        end

        local chances = {
            { 'bloxy fuiryt', Options.bloxfutiChance.Value },
        }
